...
# Author: Topaz Daniel 
# Project: Analyser Automation Script
# Description:Automated Bash script for forensic analysis of HDD and memory images using Volatility, Binwalk, Foremost, Bulk_Extractor, and Strings.
